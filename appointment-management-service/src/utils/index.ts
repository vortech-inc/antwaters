...
const {EXCHANGE_NAME,MEDICAL_SERVICE_BINDING_KEY, MESSAGE_BROKER_URL, QUEUE_NAME} = config
...
export const subscribeMessage = async (channel: Channel, service: any) => {
    ...
    channel.bindQueue(appQueue.queue, EXCHANGE_NAME, MEDICAL_SERVICE_BINDING_KEY)
    ...
    {noAck: false})
        ...
        throw Error("failed to subscribe to messages")
}
}